...
.login-form {
  ...
  :deep(.el-button--primary) {
    background: linear-gradient(135deg, #3d6db5 0%, #5ba3f0 100%);
    border: none;
    box-shadow: 0 4px 15px rgba(61, 109, 181, 0.5);
    transition: all 0.3s ease;
    
    &:hover {
      background: linear-gradient(135deg, #2c5aa0 0%, #4a90e2 100%);
      box-shadow: 0 6px 20px rgba(61, 109, 181, 0.7);
      transform: translateY(-2px);
    }
    
    &:active {
      transform: translateY(0);
      box-shadow: 0 2px 10px rgba(61, 109, 181, 0.5);
    }
  }
}
.login-tip {
