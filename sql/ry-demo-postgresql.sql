...
VALUES
	...
	(149,'admin','127.0.0.1','内网IP','Chrome 14','Mac OS X','0','登录成功','2025-12-11 16:06:03'),
	(150,'admin','127.0.0.1','内网IP','Downloading Tool','Unknown','1','验证码已失效','2025-12-13 16:59:53'),
...
VALUES
	...
	(4,'官方网站',0,4,'http://ai-quick.dev',NULL,'','',0,0,'M','0','0','','global-outlined','admin','2025-12-01 04:31:33','admin','2025-12-11 14:11:11','若依官网地址'),
	(100,'用户管理',1,1,'user','system/user/index','','',1,0,'C','0','0','system:user:list','user-outlined','admin','2025-12-01 04:31:33','',NULL,'用户管理菜单'),
	(101,'角色管理',1,2,'role','system/role/index','','',1,0,'C','0','0','system:role:list','safety-certificate-outlined','admin','2025-12-01 04:31:33','admin','2025-12-11 14:27:36','角色管理菜单'),
	(102,'菜单管理',1,3,'menu','system/menu/index','','',1,0,'C','0','0','system:menu:list','unordered-list-outlined','admin','2025-12-01 04:31:33','',NULL,'菜单管理菜单'),
	(103,'部门管理',1,4,'dept','system/dept/index','','',1,0,'C','0','0','system:dept:list','apartment-outlined','admin','2025-12-01 04:31:33','',NULL,'部门管理菜单'),
	(104,'岗位管理',1,5,'post','system/post/index','','',1,0,'C','0','0','system:post:list','idcard-outlined','admin','2025-12-01 04:31:33','',NULL,'岗位管理菜单'),
	(105,'字典管理',1,6,'dict','system/dict/index','','',1,0,'C','0','0','system:dict:list','database-outlined','admin','2025-12-01 04:31:33','',NULL,'字典管理菜单'),
	(106,'参数设置',1,7,'config','system/config/index','','',1,0,'C','0','0','system:config:list','setting-outlined','admin','2025-12-01 04:31:33','admin','2025-12-11 14:40:28','参数设置菜单'),
	(107,'通知公告',1,8,'notice','system/notice/index','','',1,0,'C','0','0','system:notice:list','notification-outlined','admin','2025-12-01 04:31:33','',NULL,'通知公告菜单'),
	(108,'日志管理',1,9,'log','','','',1,0,'M','0','0','','file-search-outlined','admin','2025-12-01 04:31:33','',NULL,'日志管理菜单'),
	(109,'在线用户',2,1,'online','monitor/online/index','','',1,0,'C','0','0','monitor:online:list','wifi-outlined','admin','2025-12-01 04:31:33','',NULL,'在线用户菜单'),
	(110,'定时任务',2,2,'job','monitor/job/index','','',1,0,'C','0','0','monitor:job:list','schedule-outlined','admin','2025-12-01 04:31:33','',NULL,'定时任务菜单'),
	(111,'数据监控',2,3,'druid','monitor/druid/index','','',1,0,'C','0','0','monitor:druid:list','fund-outlined','admin','2025-12-01 04:31:33','',NULL,'数据监控菜单'),
	(112,'服务监控',2,4,'server','monitor/server/index','','',1,0,'C','0','0','monitor:server:list','cloud-server-outlined','admin','2025-12-01 04:31:33','',NULL,'服务监控菜单'),
	(113,'缓存监控',2,5,'cache','monitor/cache/index','','',1,0,'C','0','0','monitor:cache:list','hdd-outlined','admin','2025-12-01 04:31:33','',NULL,'缓存监控菜单'),
	(114,'缓存列表',2,6,'cacheList','monitor/cache/list','','',1,0,'C','0','0','monitor:cache:list','table-outlined','admin','2025-12-01 04:31:33','',NULL,'缓存列表菜单'),
	(500,'操作日志',108,1,'operlog','monitor/operlog/index','','',1,0,'C','0','0','monitor:operlog:list','file-done-outlined','admin','2025-12-01 04:31:33','',NULL,'操作日志菜单'),
	(501,'登录日志',108,2,'logininfor','monitor/logininfor/index','','',1,0,'C','0','0','monitor:logininfor:list','login-outlined','admin','2025-12-01 04:31:33','',NULL,'登录日志菜单'),
...
VALUES
	...
	(125,'参数管理',2,'com.ruoyi.web.controller.system.SysConfigController.edit()','PUT',1,'admin','科技研发部','/system/config','127.0.0.1','内网IP','{\"configId\":100,\"configKey\":\"openai.api.key\",\"configName\":\"OpenAI-API密钥\",\"configType\":\"N\",\"configValue\":\"sk-2aI5Qrp27npjoSUJvnHDEhEStWTnzeRYmM8KYmW9sczKe9BY\",\"createBy\":\"admin\",\"createTime\":\"2025-12-11 15:29:53\",\"params\":{},\"remark\":\"OpenAI API 密钥，用于调用 OpenAI 接口\",\"updateBy\":\"admin\"}','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2025-12-11 15:35:48',195),
	(126,'参数管理',2,'com.ruoyi.web.controller.system.SysConfigController.edit()','PUT',1,'admin','科技研发部','/system/config','127.0.0.1','内网IP','{\"configId\":101,\"configKey\":\"openai.api.baseUrl\",\"configName\":\"OpenAI-API基础地址\",\"configType\":\"N\",\"configValue\":\"https://api.moonshot.cn/v1\",\"createBy\":\"admin\",\"createTime\":\"2025-12-11 15:29:53\",\"params\":{},\"remark\":\"OpenAI API 基础地址，默认为官方地址\",\"updateBy\":\"admin\"}','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2025-12-11 15:36:18',61),
	(127,'参数管理',2,'com.ruoyi.web.controller.system.SysConfigController.edit()','PUT',1,'admin','科技研发部','/system/config','127.0.0.1','内网IP','{\"configId\":103,\"configKey\":\"openai.api.model\",\"configName\":\"OpenAI-默认模型\",\"configType\":\"N\",\"configValue\":\"kimi-k2-0905-preview\",\"createBy\":\"admin\",\"createTime\":\"2025-12-11 15:36:18\",\"params\":{},\"remark\":\"OpenAI API 默认使用的模型，如 gpt-3.5-turbo、gpt-4 等\",\"updateBy\":\"admin\"}','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2025-12-11 15:36:35',91),
	(128,'参数管理',2,'com.ruoyi.web.controller.system.SysConfigController.edit()','PUT',1,'admin','科技研发部','/system/config','127.0.0.1','内网IP','{\"configId\":102,\"configKey\":\"openai.api.stream\",\"configName\":\"OpenAI-流式输出开关\",\"configType\":\"N\",\"configValue\":\"false\",\"createBy\":\"admin\",\"createTime\":\"2025-12-11 15:29:53\",\"params\":{},\"remark\":\"是否启用流式输出，true=启用，false=禁用\",\"updateBy\":\"admin\"}','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2025-12-11 15:38:07',97),
	(129,'参数管理',5,'com.ruoyi.web.controller.system.SysConfigController.export()','POST',1,'admin','科技研发部','/system/config/export','127.0.0.1','内网IP','{\"pageSize\":\"10\",\"isAsc\":\"desc\",\"orderByColumn\":\"createTime\",\"pageNum\":\"1\"}',NULL,0,NULL,'2025-12-11 16:06:21',497),
	(130,'参数管理',3,'com.ruoyi.web.controller.system.SysConfigController.remove()','DELETE',1,'admin','科技研发部','/system/config/102,101,100,103','127.0.0.1','内网IP','[102,101,100,103]','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2025-12-11 16:06:41',138),
	(131,'参数管理',9,'com.ruoyi.web.controller.system.SysConfigController.refreshCache()','DELETE',1,'admin','科技研发部','/system/config/refreshCache','127.0.0.1','内网IP','','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2025-12-11 16:06:43',41),
	(132,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.chatPost()','POST',1,'admin','科技研发部','/ai/chat/chat','127.0.0.1','内网IP','{\"message\":\"hi\\n\",\"temperature\":null}','{\"body\":{\"message\":\"Hello! 👋 How can I help you today?\"},\"headers\":{},\"statusCode\":\"OK\",\"statusCodeValue\":200}',0,NULL,'2025-12-13 17:06:08',11172),
	(133,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.chatPost()','POST',1,'admin','科技研发部','/ai/chat/chat','127.0.0.1','内网IP','{\"message\":\"nihao \",\"temperature\":null}','{\"body\":{\"message\":\"你好！很高兴见到你！😊 \\n\\n有什么我可以帮助你的吗？无论是学习、工作还是生活上的问题，我都很乐意为你提供帮助！\"},\"headers\":{},\"statusCode\":\"OK\",\"statusCodeValue\":200}',0,NULL,'2025-12-13 17:06:44',11640),
	(134,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.chatPost()','POST',1,'admin','科技研发部','/ai/chat/chat','127.0.0.1','内网IP','{\"message\":\"你是什么模型\",\"temperature\":null}','{\"body\":{\"message\":\"你好！我是DeepSeek，由深度求索公司创造的AI助手。我是DeepSeek最新版本模型，知识截止日期为2024年7月。\\n\\n我是一个纯文本模型，具有以下特点：\\n- 支持128K上下文长度\\n- 具备文件上传功能，可以处理图像、txt、pdf、ppt、word、excel等文件并读取其中的文字信息\\n- 支持联网搜索（需要用户在Web/App中手动开启）\\n- 完全免费使用\\n- 可通过官方应用商店下载App使用\\n\\n我没有语音功能，但专注于通过文字为用户提供准确、有用的帮助。有什么问题我可以为你解答吗？😊\"},\"headers\":{},\"statusCode\":\"OK\",\"statusCodeValue\":200}',0,NULL,'2025-12-13 17:08:08',14765),
	(135,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.chatPost()','POST',1,'admin','科技研发部','/ai/chat/chat','127.0.0.1','内网IP','{\"message\":\"你是什么模型\",\"temperature\":null}','{\"body\":{\"message\":\"你好！我是DeepSeek，由深度求索公司创造的AI助手。😊\\n\\n我是DeepSeek最新版本模型，是一个纯文本模型，具有以下特点：\\n- 支持128K上下文长度\\n- 具备文件上传功能，可以处理图像、txt、pdf、ppt、word、excel等文件并读取其中的文字信息\\n- 支持联网搜索（需要用户在Web/App中手动开启）\\n- 完全免费使用\\n- 可通过官方应用商店下载App使用\\n\\n我没有语音功能，但会以热情细腻的方式为你提供帮助！如果你想了解更具体的版本信息，建议查阅官方文档和公告获取最新详情。\\n\\n有什么问题我可以帮你解答吗？我很乐意为你提供帮助！✨\"},\"headers\":{},\"statusCode\":\"OK\",\"statusCodeValue\":200}',0,NULL,'2025-12-13 17:08:21',5244),
	(136,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:16:50',17),
	(137,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:17:57',56),
	(138,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:19:57',17),
	(139,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:20:23',5),
	(140,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\\n\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:22:15',21),
	(141,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:24:07',9),
	(142,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:24:54',8),
	(143,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:25:10',1),
	(144,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\\n\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:27:38',44),
	(145,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:27:48',6),
	(146,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:28:27',4),
	(147,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:28:35',1),
	(148,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:32:08',5),
	(149,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\\n\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:34:02',7),
	(150,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:35:07',3),
	(151,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:36:36',5),
	(152,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\\n\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:40:14',12),
	(153,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:43:47',4),
	(154,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:44:45',6),
	(155,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:46:31',5),
	(156,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:48:00',6),
	(157,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:49:22',4),
	(158,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"写篇 500 字文章。\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:50:52',11),
	(159,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:54:06',12),
	(160,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChatPost()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 17:56:32',4),
	(161,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"写篇 500 字文章。\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 18:02:13',10),
	(162,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"写篇 500 字文章。数据引用表格。章节清晰\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 18:04:35',7),
	(163,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 18:25:56',64),
	(164,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 18:41:16',106),
	(165,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 18:42:20',71),
	(166,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 19:08:16',168),
	(167,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-13 19:10:22',44),
	(168,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-14 03:06:00',23),
	(169,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"21\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-14 03:38:26',26),
	(170,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"111\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-14 03:44:15',11),
	(171,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"111\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-14 03:54:26',13),
	(172,'AI聊天',0,'com.ruoyi.web.controller.ai.AiChatController.streamChat()','POST',1,'admin','科技研发部','/ai/chat/stream','127.0.0.1','内网IP','{\"message\":\"你好\",\"temperature\":null}','{\"prefetch\":-1,\"scanAvailable\":true}',0,NULL,'2025-12-14 04:03:33',23),
